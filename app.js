...
const star_btn = document.querySelector(".start_btn button");
...
/* si hacen clic en el botón de inicio de la prueba */
star_btn.onclick = () =>{
    info_box.classList.add("activeInfo"); //mostrar el cuadro de información
}

/* si hacen clic en el botón de salir de la prueba */
exit_btn.onclick = () =>{
    info_box.classList.remove("activeInfo"); //ocultar el cuadro de información
}

/* si hacen clic en el botón de continuar */
continue_btn.onclick = () =>{
    info_box.classList.remove("activeInfo");
    quiz_box.classList.add("activeQuiz"); //Mostrar el cuadro de preguntas
    showQuestions(0);
    queCounter(1);
    startTimer(15);
    startTimerLine(0);
...
/* si hacen clic en el botón de siguiente */
next_btn.onclick = ()=>{
...
/* obteniendo preguntas y opciones de arrray */
...
function optionSelected(answer){
    ...
    if(userAns == correctAns){
        ...
        /* Si la respuesta es incorrecta, seleccione automáticamente la respuesta correcta.*/
    ...
    /* una vez que el usuario ha seleccionado deshabilitar todas las opciones */
    for(let i = 0; i < allOptions; i++) {
